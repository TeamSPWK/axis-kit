...
작업 디렉토리: {워크트리_경로}
주의사항:
- 이 프로젝트에는 Nova Quality Gate가 설치되어 있어. Nova 커맨드(/plan, /review, /gap, /verify 등)를 적극 활용해.
- 작업이 끝나면 아래 내용을 정리해서 알려줘:
  1. 어떤 작업을 했는지 요약
  2. Nova 커맨드 사용 경험 — 잘 된 점, 불편했던 점, 안 먹힌 점
  3. "이런 기능이 있었으면" 하는 점
  4. Nova가 과도하게 개입하거나 부족했던 순간
```
