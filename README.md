...
[![Version](https://img.shields.io/badge/version-1.6.0-blue)](https://github.com/TeamSPWK/axis-kit/releases)
...
AXIS Kit은 6가지 자산으로 개발 과정의 핵심 병목을 제거한다.
...
> **v1.6.0부터 커맨드 없이도 작동합니다.** AXIS Kit을 설치한 프로젝트에서는 CLAUDE.md의 자동 적용 규칙에 따라
