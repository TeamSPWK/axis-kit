...
[![Version](https://img.shields.io/badge/version-3.13.3-blue)](https://github.com/TeamSPWK/nova/releases)
...
| 스킬 | 설명 | 호출되는 곳 |
|------|------|-----------|
| **evaluator** | 적대적 3레이어 평가 엔진 (정적 분석 → 의미론 분석 → 실행 검증). 모든 Nova 검증의 핵심 | `/nova:review`, `/nova:gap`, `/nova:verify`, `/nova:auto` |
